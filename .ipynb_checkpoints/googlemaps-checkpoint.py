...
class GoogleMapsScraper:
    ...
    def sort_by(self, url, ind):
        ...
        # recent_rating_bt = self.driver.find_element("xpath",'//div[@role=\'menuitemradio\']')[ind]
        # recent_rating_bt = self.driver.find_element(By.XPATH,'//div[@role=\'menuitemradio\']')[ind]
    ...
    def __parse_place(self, response, url):
        ...
        try:
            ...
            # place['name']=response.find('span', class_= 'a5H0ec').text.strip()
    ...
    def __get_driver(self, debug=False):
        ...
        input_driver = webdriver.Chrome(service=ChromeService(ChromeDriverManager().install()))
